...
При автоматической установке библиотеки посредством **pip** все требуемые зависимости будут загружены пакетным менеджером автоматически при первоначальной загрузке проекта.
